...
- **Zero database overhead.** No separate database is required. All data — including events, cases, and credentials — is stored directly within your Wazuh Indexer / OpenSearch environment. 
